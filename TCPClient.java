        ...
        try {
            ...
            if (client.lastResponse != null) {
                if (client.lastResponse.equals("LOGIN OK") || client.lastResponse.equals("REGISTER OK")) {
                    ...
                    System.out.println("Format: sendMessage <receiver> \"<message>\"");
                    System.out.println("Example: sendMessage alice \"Hello!\"");
            ...
            while (client.running && scanner.hasNextLine()) {
                ...
                // Send message - accept anything starting with sendMessage (parsed on server)
                if (userInput.startsWith("sendMessage")) {
                    client.sendMessage(userInput);
                    System.out.print("> ");
                } else {
                    // Debug: check input content
                    System.err.println("[DEBUG] Input received: '" + userInput + "' (length: " + userInput.length() + ")");
                    System.out.println("Unknown command. Use: sendMessage <receiver> \"<message>\"");
                    System.out.print("> ");
                }
            }
